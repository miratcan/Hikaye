...
places = PlaceContainer([
    Place(
        ...
        "dün gece çok soguk<<<ğuktu. Rüzgarın suları donduracak "
        "soğukluğunu  kemiklerinde hissetmiştin<m. Üzerin<mdede<< de bir "
        "kazak ve soğuktan koruyamayacak kadar ince bir de palton vardı. "
        "Üşümene aldırmadan bir o sokaktan bir o sokağa gezip durmustun. "
        "Evlerde yakılan kömürden çıkan pis havanın kokusunu en derinlerde "
        "hissetmiştin. Evinin olduğu Sok<<<sokağın köşesine geldiğinde "
        "durdun. Gecenin karanlığını yok edip sokağı<<<<<<etrafı zar zor "
        "aydınlatan sokak lambasının altında son sigaranı içtin. Etrafta "
